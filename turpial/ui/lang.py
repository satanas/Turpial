...
STRINGS = {
    ...
    'message_enqueued': _("Message enqueued"),
    ...
    'message_enqueued_due_to_error': _('A message has been enqueued due to error posting'),
    'message_enqueued_successfully': _('A message has been enqueued successfully'),
    'close': _('Close'),
    'general': _('General'),
