...
class ProfileHeaderWebview(QWebView):
    ...
    def update_profile(self, profile):
        header = self.__load_template('profile_header.html')
        args = {'stylesheet': self.stylesheet, 'fullname': profile.fullname,
                'username': profile.username}
        html = header.render(args)
        self.setHtml(html)
